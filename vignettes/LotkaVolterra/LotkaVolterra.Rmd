...
$$
Notice how growth at any instantaneous point in time. Also notice that we added two *i* subscripts to $\alpha$, and it is probably becoming pretty obvious how we include the effect of another species.
